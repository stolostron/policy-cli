...
require (
	...
	github.com/stolostron/go-template-utils/v7 v7.3.1-0.20260803143658-fdceb1074d75
	open-cluster-management.io/config-policy-controller v0.19.1-0.20260803204645-8e021d894d08
)
