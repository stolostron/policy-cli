...
require (
	...
	github.com/stolostron/go-template-utils/v6 v6.5.1-0.20250410174015-9d064622318e
	open-cluster-management.io/config-policy-controller v0.16.1-0.20250411175754-19f4f66f3cf3
)
