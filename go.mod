...
require (
	...
	github.com/stolostron/go-template-utils/v7 v7.3.1-0.20260501181124-2252e1c0c57b
	open-cluster-management.io/config-policy-controller v0.18.1-0.20260504153716-520bc30ce9de
)
