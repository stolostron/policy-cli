...
require (
	...
	github.com/stolostron/go-template-utils/v6 v6.5.1-0.20250326134419-bbea96680f34
	open-cluster-management.io/config-policy-controller v0.16.1-0.20250403172446-a509b20ab509
)
