...
require (
	...
	github.com/stolostron/go-template-utils/v7 v7.1.1-0.20260112145104-56ce43211da2
	open-cluster-management.io/config-policy-controller v0.17.1-0.20260112152220-f1a2e8bdbb68
)
