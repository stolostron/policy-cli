...
require (
	...
	github.com/stolostron/go-template-utils/v6 v6.4.1-0.20250128184223-ea52e1a2444f
	open-cluster-management.io/config-policy-controller v0.15.1-0.20250207160400-b2037238d959
)
