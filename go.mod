...
require (
	...
	github.com/stolostron/go-template-utils/v7 v7.3.1-0.20260622145615-482107cc31b8
	open-cluster-management.io/config-policy-controller v0.19.1-0.20260629144316-417070d344c2
)
