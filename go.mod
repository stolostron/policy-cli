...
require (
	...
	github.com/stolostron/go-template-utils/v6 v6.4.1-0.20241206135427-d88ffa3ecacb
	open-cluster-management.io/config-policy-controller v0.15.1-0.20241210144437-facb1a80d027
)
